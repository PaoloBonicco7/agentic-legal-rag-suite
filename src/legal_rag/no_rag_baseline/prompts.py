"""Prompt builders for no-RAG baseline runs."""
...
def build_mcq_prompt(record: dict[str, Any]) -> str:
    """Build an MCQ answer prompt without retrieval context."""
    return (
        "You answer Italian legal multiple-choice questions without external retrieval context.\n"
...
def build_no_hint_prompt(record: dict[str, Any]) -> str:
    """Build an open-answer prompt without retrieval context."""
    return (
        "You answer Italian legal questions precisely and concisely without external retrieval context.\n"
